    ...
    <>
      <section className="relative">
        <Container className="flex flex-col gap-6 py-10 sm:py-16">
          ...
          <EmptyState
            message="Hero Image / Video 영역 (준비 중)"
            className="mt-2 aspect-video w-full sm:aspect-[21/9]"
          />
      ...
      <section id="youtube" className="border-t border-neutral-200 py-14 sm:py-20">
        <Container>
          ...
          <button
            ...
            className="mt-6 flex h-12 w-fit cursor-not-allowed items-center rounded-full border border-neutral-300 bg-white px-6 text-base font-semibold text-neutral-400"
          >
            유튜브 채널 바로가기 (준비 중)
          </button>
        </Container>
      ...
      <section id="review" className="border-t border-neutral-200 bg-neutral-50 py-14 sm:py-20">
        <Container>
          ...
          <Link href="/review" className={`${outlineButton} w-fit`}>
            목록 보기
          </Link>
        </Container>
      </section>
      ...
      <section className="border-t border-neutral-200 py-14 sm:py-20">
        <Container className="flex flex-col items-center gap-4 text-center">
          ...
          <Link href="/contact" className={`${primaryButton} w-fit`}>
            문의하기
          </Link>
        </Container>
      </section>
